                ...
                <div class="card recent-sales overflow-auto">
                    <div class="filter">
                        <a class="btn btn-primary rounded-pill espaco" href="#" data-bs-toggle="modal"
                            data-bs-target="#staticBackdrop"><i class="bi bi-plus-circle"></i> Nova Registro do BID</a>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">
                                            ...
                                            <td><span class="badge">
                                                    <font style="vertical-align: inherit;">
                                                        <font style="vertical-align: inherit;"><a
                                                                class="btn btn-success rounded-pill" href="#"
                                                                title="Visualizar Atleta"><i class="bi bi-eye"></i></a></font>
                                                        <font style="vertical-align: inherit;"><a
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Cadastrar Registro do BID</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Formulário do BID</h5>
                            <p class="mb-3 bt-5 text-center">Preencha o formulário abaixo para adicionar novos talentos
                                à nossa Escolinha!</p>
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="form-floating">
                                        <img class="rounded-circle img-fluid"
                                            src="<?php echo URL . 'public/uploads/atletaA.jpg'; ?>" alt="Patrocinador 1"
                                            style="width:120px;">
                                    </div>
                                </div>
                                <div class="col-md-12 text-center">
